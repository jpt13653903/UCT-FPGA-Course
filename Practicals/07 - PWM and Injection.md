...
- Pre-load a RAM block ($2^{16}$ &times; 16-bit) with
  [the MIF file provided](../Modules/Audio%20Injection/Audio.mif).
  It contains audio, generated by means of the
  [convert.py script](../Modules/Audio%20Injection/convert.py)
...
- Add the provided [`VirtualJTAG_MM.v`](../Modules/SDRAM%20Loader/VirtualJTAG_MM.v)
...
- Use the provided [`convert.py`](../Modules/Audio%20Injection/convert.py)
  Python script to create a test data file.  The mp3 provided is licensed under
  CC BY and therefore free to use.  You may, however, use your own mp3, just
  don't publish it without permission.
- Use the provided [`WriteData.tcl`](../Modules/SDRAM%20Loader/WriteData.tcl)
